/****************************************************************************
** Meta object code from reading C++ file 'arduino1.h'
**
...
#error "The header file 'arduino1.h' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSArduinoManagerENDCLASS = QtMocHelpers::stringData(
    "ArduinoManager",
    "cardRead",
    "",
    "uid",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSArduinoManagerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSArduinoManagerENDCLASS_t qt_meta_stringdata_CLASSArduinoManagerENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14),  // "ArduinoManager"
        QT_MOC_LITERAL(15, 8),  // "cardRead"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 3),  // "uid"
        QT_MOC_LITERAL(29, 14)   // "onDataReceived"
    },
    "ArduinoManager",
    "cardRead",
    "",
...
void ArduinoManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->cardRead((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ArduinoManager::cardRead; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ArduinoManager::cardRead(const QString & _t1)
{
