...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSCustomCalendarWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSCustomCalendarWidgetENDCLASS_t qt_meta_stringdata_CLASSCustomCalendarWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 20),  // "CustomCalendarWidget"
        QT_MOC_LITERAL(21, 11),  // "dateClicked"
        QT_MOC_LITERAL(33, 0),  // ""
...
void CustomCalendarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CustomCalendarWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (CustomCalendarWidget::*)(const QDate & );
            if (_t _q_method = &CustomCalendarWidget::dateClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomCalendarWidget::dateClicked(const QDate & _t1)
{
