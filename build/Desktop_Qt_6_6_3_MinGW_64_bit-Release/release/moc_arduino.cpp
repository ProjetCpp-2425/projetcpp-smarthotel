...
Q_CONSTINIT static const qt_meta_stringdata_CLASSArduinoENDCLASS_t qt_meta_stringdata_CLASSArduinoENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 5),  // "çues"
        QT_MOC_LITERAL(14, 9),  // "donneesRe"
        QT_MOC_LITERAL(24, 4),  // "void"
        QT_MOC_LITERAL(29, 6)   // "donnee"
    },
    "Arduino",
    "çues",
    "donneesRe",
...
Q_CONSTINIT const QMetaObject Arduino::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSArduinoENDCLASS_t,
        ...
        // method 'çues'
        QtPrivate::TypeAndForceComplete<donneesRe, std::false_type>,
...
void Arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: { donneesRe _r = _t->çues((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< donneesRe*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = donneesRe (Arduino::*)(const QString & );
            if (_t _q_method = &Arduino::çues; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
donneesRe Arduino::çues(const QString & _t1)
{
    donneesRe _t0{};
