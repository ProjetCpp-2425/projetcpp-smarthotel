...
QSqlQueryModel* Produit::afficher(const QString& sortOrder) {
    QSqlQuery query;
    query.prepare("SELECT id, nomProduit, quantiteDispo, dateLivraison, dateReapprovisionnement FROM STOCKS " + sortOrder);
    query.exec();
